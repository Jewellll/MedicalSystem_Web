...
<!--                <el-table-column prop="desc" label="案例是否发布" width="50px"></el-table-column>-->
                <el-table-column label="操作" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button type="primary"  size="mini" @click="fileView(scope.$index, scope.row)">查看学生提交文件</el-button>
                        <el-button type="primary"  size="mini" @click="imageView(scope.$index, scope.row)">查看案例图片</el-button>
                        <!-- 删除按钮 -->
