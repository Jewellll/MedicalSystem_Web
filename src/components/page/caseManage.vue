        ...
        <div class="table">
            ...
            <div class="toolbar">
                <el-row :gutter="20">
                    ...
                    <el-col :span="2">
                        <el-button type="primary" @click="addFormVisible=true">添加案例</el-button>
                    </el-col>
                    <el-col :span="2">
...
export default {
  data () {
    ...
    return {
      ...
      // 获取的用户列表
      caseList: [{case_id: '1', casename: '案例一', teacher_id: '张主任', createtime: '2020-01-12', desc: '是'},
        {case_id: '2', casename: '案例二', teacher_id: '张主任', createtime: '2020-02-14', desc: '是'},
        {case_id: '3', casename: '案例三', teacher_id: '张主任', createtime: '2020-08-5', desc: '是'}],
      sels: [], // 列表选中列
      // 总数
      total: 0,
      // 列表加载
      ...
      editForm: {case_id: '', casename: '', teacher_id: '', create_time: '', desc: ''},
      editFormRules: {
        case_id: [
          {required: true, message: '请输入案例号', trigger: 'blur'},
          {min: 2, max: 10, message: '长度在 3 到 10 个字符', trigger: 'blur'}
